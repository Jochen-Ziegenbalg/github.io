...
var Sprache = 0;
var naechsteZahl = new Array("Nächste zu verarbeitende Zahl: &nbsp;&nbsp; ", 
							 "Next number to be processed: &nbsp;&nbsp; "); 
var Wurzelueberschritten = new Array("Die Wurzel ist überschritten. &nbsp;&nbsp; ", 
					    			 "You have passed the square root. &nbsp;&nbsp; "); 
var Wurzelerreicht1 = new Array("Die Wurzel ist erreicht. &nbsp;&nbsp; ", 
							 "You have reached the square root. &nbsp;&nbsp; "); 
var Wurzelerreicht2 = new Array("(Sie wird im nächsten Schritt verarbeitet.) ", 
...
function SiebStart() {
  if( ! (document.Eratosthenes.grenze.value > 2)) {
	  document.Eratosthenes.grenze.value = 250}; 
